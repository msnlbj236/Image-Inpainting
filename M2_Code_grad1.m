...
%establish index matrix to calculate grad_x and grad_y from the image vect
%the index is established in the way to get imgradientxy(I1,'intermediate')
%that is to use nearest neighbour to get the gradient
...
Q_new=shrink1(x(IndexD1)-x(IndexD2)-V_2/mu,1/mu);% Q L-1 norm is minimized
